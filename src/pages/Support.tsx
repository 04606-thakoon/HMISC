        ...
        <div className="bg-white min-h-screen">
            ...
            <div className="relative bg-burgundy py-24 text-center overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <Heart className="w-20 h-20 mx-auto mb-8 text-gold animate-pulse" />
                    <h1 className="text-4xl font-bold text-ivory mb-4 tracking-wide">
                        支持我們 (Support Us)
                    </h1>
                    <div className="silk-thread mx-auto w-16 bg-ivory/50"></div>
                    <p className="text-xl text-ivory/90 font-sans tracking-wider">您的支持，是我們前行的力量。</p>
                </div>
            </div>
